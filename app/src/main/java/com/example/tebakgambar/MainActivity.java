...
public class MainActivity extends AppCompatActivity {
    ImageView imageView_line, imageView_whatsapp, imageView_youtube, imageView_instagram, imageView_snapchat, imageView_twitter ;
    @Override
    ...
    private void setInisialisasi() {
        imageView_line= (ImageView)findViewById(R.id.imageView_line);
        imageView_snapchat = (ImageView)findViewById(R.id.imageView_snapchat);
        ...
        imageView_whatsapp = (ImageView)findViewById(R.id.imageView_whatsapp);
